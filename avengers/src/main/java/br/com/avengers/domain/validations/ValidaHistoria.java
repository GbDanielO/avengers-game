...
@Component
public class ValidaHistoria extends AbstractValidador {
    ...
    public void valida(Avenger avenger, List<ResponseError> erros) {
        if(!PATTERN.matcher(avenger.getHistoria()).matches()){
            erros.add(
                    new ResponseError("Verifique os caracteres usados na história do personagem. " +
